...
public class SayHelloDelegate implements JavaDelegate {
  ...
  public void execute(DelegateExecution execution) throws Exception {
    ...
    logger.info("--------------------------------------");
    logger.info("executed sayHelloDelegate: {}", execution.getCurrentActivityName());
    logger.info("executed Variable: {}",  execution.getVariable("One"));
    ...
    logger.info("текущий пользователь: {}",s  );*/
